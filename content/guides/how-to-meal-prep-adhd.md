---
title: "How to Meal Prep with ADHD (Without Losing Your Mind)"
date: 2026-02-22
draft: false
tags: ["adhd", "meal prep", "executive function", "kitchen", "nutrition"]
categories: ["guides"]
description: "ADHD meal prep guide that actually works. Simple strategies for executive dysfunction, decision fatigue, and the 'what's for dinner' dread."
author: "The FocusHack Team"
ShowToc: true
TocOpen: true
---
...
- **Time blindness:** "This recipe takes 20 minutes" means 55 minutes for you. ([More on time blindness](/guides/adhd-time-blindness-tools/))
...
On your prep day (pick one, put it in your [calendar](/guides/how-to-use-calendar-adhd/)):
...
**Example rotation:**
1. Stir-fry (protein + whatever veggies you prepped + sauce + rice)
2. Tacos/wraps (protein + salsa + cheese + whatever)
3. Pasta with jarred sauce and a vegetable
4. Sheet pan dinner (protein + vegetables, seasoning, oven, done)
5. "Adult lunchable" — crackers, cheese, deli meat, fruit, done
...
- **Set a [visual timer](/reviews/best-visual-timers-adhd/) for 20 minutes** — "I just need to prep for 20 minutes, then I can stop"
...
- **Use body doubling** — prep with a partner, or use a [body doubling app](/guides/body-doubling-apps-adhd/) if you're solo

### Rule 4: Invest in ADHD-Friendly Kitchen Tools

The right tools reduce friction. These are worth every cent:

**Instant Pot / Multi-Cooker** (~€80-100) | [Check on Amazon.de](https://www.amazon.de/s?k=Instant+Pot+Duo&tag=focushack-21)
...
**Sheet Pan Set** (~€20-30) | [Check on Amazon.de](https://www.amazon.de/s?k=Backblech+Set+Edelstahl&tag=focushack-21)
...
**Glass Meal Prep Containers** (~€25-35 for a set) | [Check on Amazon.de](https://www.amazon.de/s?k=Glas+Meal+Prep+Container+Set&tag=focushack-21)
...
**Magnetic Whiteboard for Fridge** (~€10-15) | [Check on Amazon.de](https://www.amazon.de/s?k=magnetisches+Whiteboard+Kühlschrank&tag=focushack-21)
...
**Food Chopper / Vegetable Dicer** (~€20-30) | [Check on Amazon.de](https://www.amazon.de/s?k=Gemüseschneider+Zwiebel+Würfel&tag=focushack-21)
...
1. **Put on music/podcast** (0 min)
2. **Set a 45-minute timer** — when it goes off, you're done regardless
3. **Cook rice or pasta** in the background (5 min active, rest is passive)
4. **Cook protein** — season 1 kg of chicken thighs with salt, pepper, garlic powder, oven at 200°C for 25 min (5 min active)
5. **Chop vegetables** while everything cooks (15-20 min)
6. **Portion into containers** (10 min)
7. **Done.** Stop. You've set yourself up for the week.
...
Put it in your calendar as a recurring event with a reminder. Set multiple alarms. Pair it with something you already do — "After Sunday morning coffee, I prep." The [calendar guide](/guides/how-to-use-calendar-adhd/) has more on building ADHD-friendly routines.
