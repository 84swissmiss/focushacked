...
|-----|----------|-------|----------|
| **Tiimo** | Visual daily planning | $3.50/mo (annual) or $10/mo | iOS, Android, Web |
| **Goblin Tools** | Breaking down overwhelming tasks | Free (premium available) | Web, iOS, Android |
| **Structured** | Time blocking your day | Free / Pro ~$5/mo | iOS, Android, Web |
| **Focus Bear** | Building morning/evening routines | ~$5/mo | Mac, Windows, iOS, Android |
| **Sunsama** | Calm, intentional daily planning | $20/mo (annual) or $25/mo | Web, Mac, Windows |
| **Todoist** | Fast, simple task capture | Free / $5/mo Pro | All platforms |
| **Notion** | Building your own ADHD system | Free / $10/mo Plus | All platforms |
| **Forest** | Staying off your phone | Free / ~$4 one-time (iOS) | iOS, Android |
| **Focusmate** | Virtual body doubling | Free (3/week) / $8/mo Plus | Web |
| **Brain.fm** | Focus music that actually works | $8.33/mo (annual) or $14.99/mo | Web, iOS, Android, Desktop |
| **Finch** | Self-care and habit building | Free / $5.83/mo (annual) | iOS, Android |
| **Lunatask** | Privacy-first task management | Free / $6/mo (annual) | Mac, Windows, Linux, iOS, Android |
