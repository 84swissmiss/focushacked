---
title: "Goblin Tools Review: Is It Actually Useful for ADHD?"
date: 2026-02-12
description: "Honest goblin tools ADHD review. I tested every feature for task paralysis, time blindness, and executive dysfunction. Here's what actually works."
...
2. Collect receipts for deductions
3. Choose a tax preparation method
4. Fill in personal information
5. Enter income details
6. Enter deductions and credits
7. Review the return
8. Submit the return
9. Save a copy for records
...
The tools process your input through AI models to generate results. Check the [privacy policy](https://goblin.tools/Privacy) for specifics on data handling. There's no user account, so nothing is stored in a profile tied to you.
...
Yes. There are official apps on both [iOS](https://apps.apple.com/app/goblin-tools/id6449003064) and [Android](https://play.google.com/store/apps/details?id=com.goblintools). Be careful to download the official one by Bram De Buyser. There are copycat apps on the stores that aren't affiliated with the original.
